...
/*
    ...
    public function talkroom()
	{
        ...
        //予約完了
        $reserve_check = $this->input->post('reserve_check');	
    ...
    //予約日変更
    public function change_reserve_date() {
		$this->load->helper('url');
		if($this->input->is_ajax_request()){
		}else {
			redirect("/");
        ...
        //date picker再びはきついか… いや　同じデザインなら
        //talkroomidと、日付が来る
        //talkroomidのある　カラムをヒットさせ　変更させる
        //まずは空っぽでない　カラム reserve_infoをひっとさせる？
